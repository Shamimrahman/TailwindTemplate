    ...
    return (
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
            <img className="object-cover object-center w-full h-full" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Population_Statistics_Goslar.svg/800px-Population_Statistics_Goslar.svg.png" alt="stats"/>
          </div>
        </div>
      </section> 
        </div>
