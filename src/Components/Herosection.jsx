...
function Herosection() {
    return (
        ...
        <div className="container mx-auto flex px-5  md:flex-row flex-col items-center">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 order-fast">
            <img  src='https://proweb365.com/wp-content/uploads/2020/05/img-wordpress-webdesign.png'  className="object-cover object-center rounded" alt="hero" />
          </div>
        </div>
      </section>
        </div>
